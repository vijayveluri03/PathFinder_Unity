...
namespace Mr1
{
    public static class PathFinderUtility 
    {
		...
		public static void FindShortestPathBetweenPointsAsynchronous (  this WaypointManager manager, Vector3 startPoint, Vector3 endPoint, PathLineType pathType, System.Action<List<Vector3>> OnPathFound )
		{
		...
		public static List<Vector3> GetStraightPathPoints( List<Vector3> nodePoints )
        {
			return nodePoints;
            // if ( wayPoints == null )
            //     return null;
        ...
        public static List<Vector3> GetCatmullRomCurvePathPoints( List<Vector3> nodePoints )
        {
            if ( nodePoints == null )
                return null;
            ...
            for( int i = 0; i < nodePoints.Count; i++ )
            {
                catmullRomPoints[i+1] = nodePoints[i];
            }
            ...
            path.Add(nodePoints[nodePoints.Count - 1]);
            return path;
        }
