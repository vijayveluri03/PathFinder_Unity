...
namespace QPathFinder
{
    ...
    public class PathFinder : MonoBehaviour
    {
        ...
        public void FindShortestPathBetweenNodesAsynchronous ( int fromNodeID, int toNodeId, System.Action<List<Node>> callback )
        {
        ...
        public List<Node> FindShortestPathBetweenNodesSynchronous( int fromNodeID, int toNodeID )
        {
